<div class="my-bookings-container">
    ...
    <?php if (isset($bookings) && is_array($bookings) && count($bookings) > 0): ?>
        <div class="bookings-list">
            <?php foreach ($bookings as $booking):
                $bookingTimestamp = strtotime($booking['start_time']);
                $currentTimestamp = time();

                $canCancel = ($bookingTimestamp > $currentTimestamp);
                $displayDate = date('Y-m-d', $bookingTimestamp);
                ...
                <div class="booking-card" id="booking-card-<?= $booking['id'] ?>">
                    <div class="booking-main-info">
                        <div class="booking-header-details">
                            ...
                            <p class="booking-date-time">
                                <i class="fa-solid fa-calendar-days"></i> <?= htmlspecialchars($displayDate) ?>
                    ...
                    <div class="booking-extra-details">
                        <div class="details-grid">
                            ...
                            <div class="detail-item">
                                <span class="detail-label">Koszt sali (z VAT):</span>
    ...
    <?php else: ?>
        <div class="empty-state">
            ...
            <a href="/dashboard?page=book-now" class="btn-book" style="display: inline-block; text-decoration: none; margin-top: 1rem;">Zarezerwuj Salę</a>
        </div>
    <?php endif; ?>
</div>